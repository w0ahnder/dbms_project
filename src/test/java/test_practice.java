...
public class test_practice {
  ...
  static void setupBeforeAllTests() throws IOException, JSQLParserException, URISyntaxException {
    ClassLoader classLoader = test_practice.class.getClassLoader();
  ...
  public void testQuery1() throws ExecutionControl.NotImplementedException, IOException, JSQLParserException, URISyntaxException {
    ...
    //SelectVisitor sv = new SelectVisitor((SelectOperator) plan, null,null , where);
    //System.out.println(sv.evaluate_expr());
    /*int expectedSize = 6;
