...
public class IndexScanOperator2 extends ScanOperator {
    ...
    public IndexScanOperator2(ArrayList<Column> outputSchema, String path, String table, File index_file, int ind, int low, int high, boolean clustered ) throws IOException {
